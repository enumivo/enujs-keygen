...
const {PrivateKey, Signature} = require('enujs-ecc')
...
describe('Keystore', () => {
  ...
  it('get derived active public keys', () => {
    ...
    assert.deepEqual(keystore.getPublicKeys(), [
      'ENU7vgT3ZsuUxWH1tWyqw6cyKqKhPjUFbonZjyrrXqDauty61SrYe',
      'ENU5MiUJEXxjJw6wUcE6yUjxpATaWetubAGUJ1nYLRSHYPpGCJ8ZU'
    ])
  })
